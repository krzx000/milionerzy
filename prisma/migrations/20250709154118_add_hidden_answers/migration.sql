...
INSERT INTO "new_game_sessions" ("createdAt", "currentQuestionIndex", "endTime", "gameTime", "id", "startTime", "status", "totalQuestions", "updatedAt", "usedAskAudience", "usedFiftyFifty", "usedPhoneAFriend") SELECT "createdAt", "currentQuestionIndex", "endTime", "gameTime", "id", "startTime", "status", "totalQuestions", "updatedAt", "usedAskAudience", "usedFiftyFifty", "usedPhoneAFriend" FROM "game_sessions";
