  ...
  return (
    <div className="fixed bottom-2 left-2 right-2 z-10">
      <div className="max-w-md mx-auto">
        <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-2xl shadow-xl px-4 py-3">
          <div className="flex items-center justify-between">
            {/* Progres pytań */}
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 bg-blue-100/30 backdrop-blur-sm rounded-md flex items-center justify-center">
            ...
            <div className="flex-1 mx-3">
              <div className="h-2 bg-white/20 backdrop-blur-sm rounded-full overflow-hidden">
                <div
                  className="h-full bg-blue-400/80 backdrop-blur-sm transition-all duration-300"
                  style={{
                    width: `${
